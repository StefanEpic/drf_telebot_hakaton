...
async def vote_emotion_keyboard(list_buttons: list, video_id: int) -> InlineKeyboardMarkup:
    """
...
async def vote_food_keyboard(list_buttons: list, video_id: int) -> InlineKeyboardMarkup:
    """
...
async def select_video_keyboard(list_buttons: list) -> InlineKeyboardMarkup:
    """
